...
def insert_many_users(names, phones):
    ...
    for notice in conn.notices:
            print("Уведомление от базы данных:", notice)
    
    cur.close()
    conn.close()


names = ['Tanirbergen ', 'Malika', 'Alua']
phones = ['1234567890', 'not_a_phone', '9876543210']
...
def main_menu():
    while True:
        ...
        print("8. Добавить много пользователей (SQL-функция)")
